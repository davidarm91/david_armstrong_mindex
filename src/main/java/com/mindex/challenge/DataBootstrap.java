...
public class DataBootstrap {
    ...
    /**
     * Loads Compensation data from a JSON file and populates the Compensation repository.
     * Ensures that each Compensation record refers to an existing Employee.
     */
